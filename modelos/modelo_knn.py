...
class ModeloKNN(Modelo):
    """Clasificador K-Nearest Neighbors con split estratificado y escalado opcional."""

    def __init__(self, datos, k: int = 5):
    ...
    def _crear_estimador(self) -> KNeighborsClassifier:
